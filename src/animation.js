export class Animation {
  ...
  static fibonacci(num) {
    return num <= 1
      ? 1
      : ThemedAnimation.fibonacci(num - 1) + ThemedAnimation.fibonacci(num - 2);
  }
...
export class ThemedAnimation extends Animation {
  constructor(ctx) {
    super(ctx);
    this.counter = 1;
  ...
  animate() {
    ...
    if (this.r === 0 && this.grow) {
      this.themeColors =
        this.themeColors[0] === 'red' ? ['blue', 'green'] : ['red', 'gold'];
      this.theme = this.themeColors;
    }
